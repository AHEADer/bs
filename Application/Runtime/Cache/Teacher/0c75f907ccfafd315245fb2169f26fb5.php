						...
						<div class='bs-info-table'>
							<form method='POST' class='form-x'>
								...
								<div class='form-group'>
									...
									<div class='field'><input class='input input-auto' name='name' size=50 data-validate="required:必填,length#<=120:40字以内"><span class='text-dot'>*</span>(40字以内)</div>
								</div>
								...
								<div class='form-group'>
									...
									<div class='field'><input class='input input-auto' name='origin' size=50  data-validate="required:必填,length#<=120:40字以内"><span class='text-dot' value='自选课题'>*</span>(40汉字以内)</div>
								</div>
								
								<div class='form-group'>
									<div class='label'>目的要求</div>
									<div class='field'><textarea class='input input-auto' name='require' rows=5 cols=70 data-validate="required:必填,length#<=900:300字以内"></textarea><span class='text-dot'>*</span>(300汉字以内)</div>
								</div>
								
								<div class='form-group'>
									<div class='label'>主要内容</div>
									<div class='field'><textarea class='input input-auto' name='content' rows="5" cols="70"  data-validate="required:必填,,,length#<=900:300字以内"></textarea><span class='text-dot'>*</span>(300汉字以内)</div>
								</div>
								
								<div class='form-group'>
									<div class='label'>预期目标</div>
									<div class='field'><textarea class='input input-auto' name='goal' cols=70  data-validate="required:必填,length#<=600:200字以内"></textarea><span class='text-dot'>*</span>(200汉字以内)</div>
								</div>
								...
								<div class='form-group'>
									...
									<div class='field'><textarea class='input input-auto' name='env' cols=70 data-validate="required:必填,length#<=600:200字以内"></textarea><span class='text-dot' >*</span>(200汉字以内)</div>
								</div>
								<div class='form-group'>
									<div class='label'>主要参考资料</div>
									<div class='field'><textarea onblur="alert('请注意保存')" class='input input-auto' name='reference' rows="8" cols="70"  data-validate="required:必填,length#<=900:300字以内"></textarea><span class='text-dot'>*</span>(300汉字以内)</div>
								</div>
