...
<!---菜单开始-->
			...
			<div class='x10 right'>
				<div class='line'>
					...
					<div class="panel-box">
					<div class="panel-head">概览
						<!-- 2015-5-31 -->
						<a class="button bg-main" style="margin-left:10px" href="<?php echo U('Admin/Bs/toexcel1');?>">已选课题导出</a>
						<a class="button bg-main" style="margin-left:10px" href="<?php echo U('Admin/Bs/toexcel2');?>">未选题学生导出</a>
						<a class="button bg-main" style="margin-left:10px" href="<?php echo U('Admin/Bs/toexcel3');?>">未被选教师导出</a>
						<!-- 2015-5-31 -->
					</div>
					<div class="panel-body">
						<div class='box'>
							<div class='num'><?php echo ($rs["snum1"]); ?>/<?php echo ($rs["snum2"]); ?></div>
							<div class='desc'>学生(已选/全部)</div>
						</div>
						
						<div class='box'>
							<div class='num'><?php echo ($rs["tnum"]); ?></div>
							<div class='desc'>教师</div>
						</div>
						
						<div class='box'>
							<div class='num'><?php echo ($rs["knum1"]); ?>/<?php echo ($rs["knum2"]); ?></div>
							<div class='desc'>课题(已审核/全部)</div>
						</div>
