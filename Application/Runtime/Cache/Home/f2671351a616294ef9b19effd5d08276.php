			...
			<div class='line'>
				...
				<div class='wrap'>
					...
					<div class='login xl12'>
						...
						<!---登录框开始-->
						<div class='text-center bg-main bg-inverse form-title'><span class='icon-users'></span>找回密码</div>
						<form  action="<?php echo U('Home/Login/forget_pwd');?>" method='POST' class='form form-x'>
									...
									<div class='form-group'>
											<div class='x3'>邮箱</div>
											<div class='x9'>
												<input type='text' name='email' class='input' data-validate="required:必填">
											</div>
									</div>
